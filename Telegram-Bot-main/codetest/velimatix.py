...
try:
    if __Author__ != ("VuXuanKien","VuXuanKien"):
        raise VELIMATIX('>> GOOD LUCK!! VELIMATIX') from None
    if __In4__ != ("https://www.facebook.com/vuxuankiendzvcl","https://t.me/xkprj"):
        raise VELIMATIX('>> GOOD LUCK!! VELIMATIX') from None
except:
    raise VELIMATIX('>> GOOD LUCK!! VELIMATIX') from None
...
#            Developer By VXK
#     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
__Author__ = ("VuXuanKien","VuXuanKien")
__In4__ = ("https://www.facebook.com/vuxuankiendzvcl","https://t.me/xkprj")
class VELIMATIX(MemoryError):0
__a__, _0xVELIxMATIX = ("VuXuanKien","VuXuanKien"), [
...
def main():
    try:
        ...
        file = sys.argv[1] if len(sys.argv) > 1 else input(stage(f"File {dark}-> {Col.reset}", "xuankien-encode", col2=bpurple)).replace('"', '').replace("'", "")
        ...
        outx = "veli-" + file
        with open(outx, 'w', encoding='utf-8') as f:
            f.write(str(LAYER))
